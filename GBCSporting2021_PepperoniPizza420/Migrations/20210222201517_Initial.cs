    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "brad@gmai.com", "Brad", "+1(111)111-1111" },
                    { 2, "chad@gmai.com", "Chad", "+1(222)222-2222" },
                    { 3, "thad@gmai.com", "Thad", "+1(333)333-3333" }
                });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "City", "CountryId", "Email", "FirstName", "LastName", "Phone", "PostalCode", "State" },
                values: new object[] { 1, "1 Blue Jays Ways", "Jeffville", 1, "jeff@jeff.com", "Jeff", "Bezos", "+1(123)321-4325", "JEF F10", "Ontario" });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "City", "CountryId", "Email", "FirstName", "LastName", "Phone", "PostalCode", "State" },
                values: new object[] { 2, "2 Blue Jays Ways", "Oliviettoville", 2, "o@liver.com", "Oliver", "Doe", "+1(122)321-4325", "JEF F10", "Ontario" });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "CustomerId", "Address", "City", "CountryId", "Email", "FirstName", "LastName", "Phone", "PostalCode", "State" },
                values: new object[] { 3, "3 Blue Jays Ways", "Franville", 3, "fran@k.com", "Francisco", "Carzone", "+1(323)321-4325", "1020", "Ontario" });
            ...
            migrationBuilder.InsertData(
                table: "Registrations",
                columns: new[] { "CustomerId", "ProductId", "RegistrationId" },
                values: new object[,]
                {
                    { 1, 1, 1 },
                    { 2, 2, 2 },
